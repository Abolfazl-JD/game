...
function move() {
    ...
    var tembricks = document.querySelectorAll('.bricks');
    if (tembricks.length == 0) {
        document.getElementById('win').style.display = 'block';
        ball.style.display = 'none';
        wood.style.display = 'none';
    }
    for (var tarbricks of tembricks) {
        if (call(tarbricks, ball)) {
            dy = -1;
            tarbricks.parentNode.removeChild(tarbricks);
        }
    }
